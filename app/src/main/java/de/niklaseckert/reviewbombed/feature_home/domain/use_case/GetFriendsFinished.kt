...
/**
 * Use Case to get all Games that friends finished recently.
 *
 * @author Niklas Eckert
 * @author Jakob Friedsam
 */
class GetFriendsFinished(
    ...
    /**
     * Method to get all Games that friends finished recently.
     *
    ...
    operator fun invoke(): Flow<Resource<List<GameExcerpt>>> {
        return repository.getFriendsFinished()
    }
}