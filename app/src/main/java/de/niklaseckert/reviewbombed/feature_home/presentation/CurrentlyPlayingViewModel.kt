...
class CurrentlyPlayingViewModel @Inject constructor(
    private val getAllCurrentlyPlaying: GetAllCurrentlyPlaying
): ViewModel() {

    private val _state = mutableStateOf(AllCurrentlyPlayingState())
    val state: State<AllCurrentlyPlayingState> = _state
